                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="tipo_documento" id="tipo_documento" class="form-control" required>
                                ...
                                <option value="Cedula de Identidad" {{ $cliente->tipo_documento == 'Cedula de Identidad' ? 'selected' : '' }}>Cédula de Identidad</option>
                                <option value="Cedula de Extranjeria" {{ $cliente->tipo_documento == 'Cedula de Extranjeria' ? 'selected' : '' }}>Cédula de Extranjería</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="horario" name="horario" required>
                                ...
                                @foreach ($horario as $horarios)
                                    <option value="{{ $horarios->id }}" {{ $horarios->id == $cliente->horario_id ? 'selected' : '' }}>
